...
report must never land somewhere public. Write "Code of Conduct" in the title
and it will be routed, not triaged as a vulnerability.

If the person you need to report **is** a maintainer, or you would rather not
go through this repository at all, use
[GitHub's own abuse reporting](https://github.com/contact/report-abuse), which
reaches GitHub Support rather than us.
