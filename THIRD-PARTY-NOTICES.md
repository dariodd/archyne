...
| @iconify-json/simple-icons@1.2.90 | CC0-1.0 |  |
| @iconify-json/tabler@1.2.36 | MIT |  |
...
- **elkjs** is licensed under the Eclipse Public License 2.0 and is used
  unmodified as a layout library; its source code is available at
