...
| @codemirror/view@6.43.6 | MIT | https://code.haverbeke.berlin/codemirror/view |
...
| @iconify-json/carbon@1.2.24 | Apache-2.0 |  |
| @iconify-json/devicon@1.2.62 | MIT |  |
| @iconify-json/logos@1.2.11 | CC0-1.0 |  |
| @iconify-json/simple-icons@1.2.92 | CC0-1.0 |  |
| @iconify-json/tabler@1.2.38 | MIT |  |
...
| codemirror-lang-mermaid@0.5.0 | MIT | https://github.com/inspirnathan/codemirror-lang-mermaid |
...
| dompurify@3.4.12 | (MPL-2.0 OR Apache-2.0) | git://github.com/cure53/DOMPurify |
...
| eventsource-parser@3.1.0 | MIT | ssh://git@github.com/rexxars/eventsource-parser |
...
| iconv-lite@0.7.3 | MIT | git://github.com/ashtuchkin/iconv-lite |
| iconv-lite@0.7.3 | MIT | git://github.com/ashtuchkin/iconv-lite |
...
| tsx@4.23.1 | MIT | privatenumber/tsx |
...
- **elkjs** is declared as `EPL-2.0 OR GPL-3.0-or-later`. That is the Eclipse
  Public License 2.0 together with its standard Exhibit A notice, which makes
  GPL-3.0-or-later _additionally_ available to a recipient who wants it — a
  choice offered, not an obligation imposed. **Archyne relies on the EPL-2.0
  arm**, unchanged from earlier versions: elkjs is used unmodified, as a
  library, with no elkjs code copied into Archyne's own sources. The EPL's
  copyleft reaches modifications to the library itself, which Archyne makes
  none of, so this places no condition on Archyne's MIT distribution. Source
  is available at <https://github.com/kieler/elkjs>.
- Icon collections (**logos**, **simple-icons**: CC0-1.0; **devicon**,
